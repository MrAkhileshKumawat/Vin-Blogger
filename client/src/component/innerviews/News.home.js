...
export class Home extends Component {
  ...
  nextpage = () => {
    var second_20 = this.state.List.slice(
      this.state.number,
  ...
  previouspage = () => {
    ...
    var previous_20 = this.state.List.slice(
  ...
  componentDidMount() {
    ...
    axios
      .get(
        "https://newsapi.org/v2/top-headlines?pageSize=100&country=in&category=Business&apiKey=9ced313f2eca4419aa010004b2bdfb1d"
      )
      .then((data) => {
  ...
  render() {
    ...
    if (this.state.number == 20) {
      ...
      previous = (
        <button className="btn btn-warning " onClick={this.previouspage}>
          previous page
        </button>
      );
      nextpage = "";
            ...
            <a href={item.url}>
              <div className="container2">
                <div className="wrapper">
                  <img src={item.urlToImage} className="img-rounded" alt="bad internet connectivity" />
                </div>
                <div class="Title">
